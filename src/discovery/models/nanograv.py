from .. import signals
import discovery as _ds   # package-level names are rebound by ds.config()
...
def makemodel_curn(psrs, rn_components=30, crn_components=14, gamma='variable'):
    ...
    pslmodels = [_ds.PulsarLikelihood([psr.residuals,
    ...
    return _ds.ArrayLikelihood(pslmodels, commongp=curngp)
...
def makemodel_hd(psrs, rn_components=30, gw_components=14, gamma='variable'):
    ...
    return _ds.ArrayLikelihood(pslmodels, commongp=rngp, globalgp=hdgp)
